...
ESTT_GROUND_CONDITIONS_CODE, CLOUD_HEIGHT_CLASSES, CLOUD_TYPE_CODE)
...
def handle_3EsTT(d):
    ...
    d : dict
        re groupdict
    """
    EsTT = {"ground_cond": ESTT_GROUND_CONDITIONS_CODE[d["E"]],
            "t_ground": handle_sTT(d["sTT"])}
...
def handle_5EsTT(d):
    ...
    d : dict
        re groupdict
    """
    EsTT = {"ground_cond_min": ESTT_GROUND_CONDITIONS_CODE[d["E"]],
            "t_ground_min": handle_sTT(d["sTT"])}
    #use ESTT_GROUND_CONDITIONS_CODE dictionary here
    return EsTT
